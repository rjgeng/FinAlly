...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/rfvitis/temp/FinAlly/.claude
                  → checks /Users/rfvitis/temp/FinAlly/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/rfvitis/temp/FinAlly/.claude/get-shit-done
                  → writes to /Users/rfvitis/temp/FinAlly/.claude/get-shit-done/hooks/
...
@/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
