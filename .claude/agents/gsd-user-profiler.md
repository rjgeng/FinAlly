...
<reference>
@/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/references/user-profiling.md` to load:
