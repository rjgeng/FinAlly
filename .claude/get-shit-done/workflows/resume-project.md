...
<required_reading>
@/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "/Users/rfvitis/temp/FinAlly/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
